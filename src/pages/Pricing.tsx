    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="text-center mb-16">
          ...
          {/* Enhanced Billing Toggle - Fixed positioning */}
          ...
          {/* Savings Indicator */}
          {billingCycle === 'yearly' && (
            <div className="inline-flex items-center px-4 py-2 bg-green-50 dark:bg-green-900 rounded-full border border-green-200 dark:border-green-700 mb-8">
        ...
        {/* Pricing Cards - Fixed spacing and layout */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 lg:gap-8 mb-16">
          {plans.map((plan, index) => (
            <div
              ...
              style={{
                // Add extra margin top for popular cards to prevent badge overlap
                marginTop: plan.popular ? '2rem' : '0',
                marginBottom: plan.popular ? '2rem' : '0'
              }}
            >
              {/* Badge - Fixed positioning */}
              {plan.badge && (
                <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 z-20">
                  <span className={`px-3 py-1 rounded-full text-xs font-bold text-white shadow-lg whitespace-nowrap ${
...
export default Pricing;import React, { useState } from 'react';
import { Link, useNavigate } from 'react-router-dom';
import { Check, Star, Zap, Crown, CreditCard, Smartphone, Copy, CheckCircle, ArrowRight, Sparkles, Users, TrendingUp, Shield, Clock, Gift, Calendar } from 'lucide-react';
import { useAuth } from '../contexts/AuthContext';
import { collection, addDoc } from 'firebase/firestore';
